...
/**
 * @extends ServiceEntityRepository<FightingStyle>
 *
...
class FightingStyleRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(FightingStyle $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(FightingStyle $entity, bool $flush = true): void
    {
